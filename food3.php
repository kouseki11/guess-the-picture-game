...
<body>
    ...
    <img class="img1" src="img/hamburger.png">
    <?php
    if(isset($_POST['cetak'])){
        $a=$_REQUEST['panjang13'];
     ...
     ?>
    <form name="form13" action="food3.php" method="POST">
    <input class="holder" type="text" name="panjang13" class="panjang13" placeholder="Write Here">
    <br>
    <a href="food2.php" class="next">PREV</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="food4.php" class="next">NEXT</a>
