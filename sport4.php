...
<body>
    ...
    <img class="img1" src="img/volleyball.png">
    <?php
    if(isset($_POST['cetak'])){
     ...
     ?>
    <form name="form9" action="sport4.php" method="POST">
    <input class="holder" type="text" name="panjang9" class="panjang9" placeholder="Write Here">
    <br>
    <a href="sport3.php" class="next">PREV</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="sport5.php" class="next">NEXT</a>
