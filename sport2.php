...
<body>
    ...
    <img class="img1" src="img/badminton.png">
    <?php
    if(isset($_POST['cetak'])){
     ...
     ?>
    <form name="form7" action="sport2.php" method="POST">
    <input class="holder" type="text" name="panjang7" class="panjang7" placeholder="Write Here">
    <br>
    <a href="sport1.php" class="next">PREV</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="sport3.php" class="next">NEXT</a>
