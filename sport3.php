...
<body>
    ...
    <img class="img1" src="img/hockey.png">
    <?php
    if(isset($_POST['cetak'])){
     ...
     ?>
    <form name="form8" action="sport3.php" method="POST">
    <input class="holder" type="text" name="panjang8" class="panjang8" placeholder="Write Here">
    <br>
    <a href="sport2.php" class="next">PREV</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="sport4.php" class="next">NEXT</a>
