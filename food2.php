...
<body>
    ...
    <img class="img1" src="img/pancake.png">
    <?php
    if(isset($_POST['cetak'])){
        $a=$_REQUEST['panjang12'];
     ...
     ?>
    <form name="form12" action="food2.php" method="POST">
    <input class="holder" type="text" name="panjang12" class="panjang12" placeholder="Write Here">
    <br>
    <a href="food1.php" class="next">PREV</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="food3.php" class="next">NEXT</a>
