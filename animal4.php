...
<body>
    ...
    <img class="img4" src="img/iguana.png">
    ...
    <form name="form4" action="animal4.php" method="POST">
    <input class="holder" type="text" name="panjang4" class="panjang4" placeholder="Write Here">
    <br>
    <a href="animal3.php" class="next">PREV</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="animal5.php" class="next">NEXT</a>
