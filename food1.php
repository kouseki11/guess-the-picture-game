...
<body>
    ...
    <img class="img1" src="img/pizza.png">
    <?php
    if(isset($_POST['cetak'])){
        $a=$_REQUEST['panjang11'];
     ...
     ?>
    <form name="form11" action="food1.php" method="POST">
    <input class="holder" type="text" name="panjang11" class="panjang11" placeholder="Write Here">
    <br>
    <a href="index.php" class="next">HOME</a>
    <input class="button" type="submit" name="cetak" value="ANSWER"> 
    <a href="food2.php" class="next">NEXT</a>
